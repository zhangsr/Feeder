...
public class FeedItemDao extends AbstractDao<FeedItem, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property FeedSourceId = new Property(6, long.class, "feedSourceId", false, "FEED_SOURCE_ID");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'FEED_ITEM' (" + //
                ...
                "'STATE' TEXT," + // 4: state
                "'DATE' INTEGER," + // 5: date
                "'FEED_SOURCE_ID' INTEGER NOT NULL );"); // 6: feedSourceId
    }
    ...
    protected void bindValues(SQLiteStatement stmt, FeedItem entity) {
        ...
        stmt.bindLong(7, entity.getFeedSourceId());
    }
    ...
    public FeedItem readEntity(Cursor cursor, int offset) {
        FeedItem entity = new FeedItem( //
            ...
            cursor.getLong(offset + 6) // feedSourceId
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, FeedItem entity, int offset) {
        ...
        entity.setFeedSourceId(cursor.getLong(offset + 6));
     }
